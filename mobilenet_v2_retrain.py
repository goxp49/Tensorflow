...
CHECKPOINT_NAME =os.path.join(OUTPUT_PATH, '_retrain_checkpoint')
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'output_graph.pb'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'intermediate_graph'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'output_labels.txt'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'retrain_logs'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'bottleneck'),
