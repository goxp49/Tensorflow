...
默认情况下这个脚本将使用高精度，但是相当大且慢的Inception_v3模型结构。
...
# 训练图集路径
TRAIN_PATH = os.path.join(Project_PATH, 'inception_v3', 'flower_photos')
# 输出路径
...
# CHECKPOINT_NAME = '/inception_v3/tmp/_retrain_checkpoint'
CHECKPOINT_NAME =os.path.join(OUTPUT_PATH, 'tmp', '_retrain_checkpoint')
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'tmp', 'output_graph.pb'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'tmp', 'intermediate_graph'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'tmp', 'output_labels.txt'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'tmp', 'retrain_logs'),
  ...
  parser.add_argument(
      ...
      default=os.path.join(OUTPUT_PATH, 'tmp', 'bottleneck'),
